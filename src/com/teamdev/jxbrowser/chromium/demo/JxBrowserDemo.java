...
public class JxBrowserDemo {
	...
	private void createMainToolBar() {
		...
		final JButton btnNewButton_2 = new JButton("隐藏");
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (btnNewButton_2.getText().trim().equals("隐藏")) {
					splitPane.setDividerLocation(splitPane.getWidth());
					splitPane.setContinuousLayout(true);
					btnNewButton_2.setText("显示");
				} else {
					splitPane.setDividerLocation(100);
					splitPane.setContinuousLayout(true);
					btnNewButton_2.setText("隐藏");
				}
			}
		});

		JButton btnNewButton_4 = new JButton("代理");
